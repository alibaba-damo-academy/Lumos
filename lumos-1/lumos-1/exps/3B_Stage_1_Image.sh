...
########################################### Data configuration #########################################
image_eval_data_config=configs/data/pre-tokenized-img-onejson-Cosmos-DV4x8x8.yaml
...
--init_from  ckpts/3B/stage-1-image \
...
--eval_data_config $image_eval_data_config \
--data_video_fps 1 \
--data_video_frames 1 \
--MaskedAR \
