...
class Tokenizer:
    def __init__(self, model_path: str):
        ...
        if model_path.endswith(".model"):  # spm tokenizer
            ...
            # self.tokenizer = AutoTokenizer.from_pretrained(model_path) # The authors changed the tokenizer so that I need to specify the version.
            self.tokenizer = AutoTokenizer.from_pretrained(model_path, revision="9624463a82ea5ce814af9b561dcd08a31082c3af") # The authors changed the tokenizer so that I need to specify the version.
